...
/** sterile neutrino nonthermal distribution parameters *///=====================================================================================================================
class_read_double("B_sp",pba->B_sp);

class_read_double("E",pba->E);

class_read_double("N0",pba->N0);

class_read_double("s",pba->s);

/*DW*///=============================================================================================================================
//class_read_double("chi",pba->chi);
...
//======================================================================================================================================
    //pba->B_sp=0.05;
   pba->T_ncdm[0]= 0.71611;
   pba->T_ncdm[1]=(pow((1-pba->B_sp),-0.25)*(4.18026));
   //pba->T_ncdm[1]= 0.22199;  // for diff. temp. thermal
   //pba->T_ncdm[1]= 0.71611;   //for DW
   //printf(" -> tncdm = %lf %lf\n",pba->T_ncdm[0],pba->T_ncdm[1]);
//======================================================================================================================================
